...
.. image:: https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/deep_dive/continuous_integration/ITRoadmap.png?raw=true
...
.. code-block::
    ...
    git clone --single-branch --depth 1 --branch "$TARGET_BRANCH" git@github.com:khulnasoft/Mapping.git
...
.. code-block::
    ...
    git clone -b master1 https://github.com/khulnasoft/Mapping.git --depth 1
...
-------------------------------
Storage Space (khulnasoft/Mapping)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Therefore, we have 32 branches (master1, master2, …, master32), on the khulnasoft/Mapping Repository, and also 32 runners on the intelligent-tests and intelligent-tests-pr Workflows.
...
The Synchronized Object here is the khulnasoft/Mapping Repository, and is accessed
...
#. The runner 2 in the intelligent-tests workflow, pulls the Mapping from the master2 branch of the khulnasoft/Mapping repository, and starts running the determined tests (based on changes made in the commit).
#. The det-test-coverage workflow completes for runner2, which makes a push to the corresponding branch in the khulnasoft/Mapping Repository.
...
.. image:: https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/deep_dive/continuous_integration/push.png?raw=true
   :alt: Push
...
.. image:: https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/deep_dive/continuous_integration/push1.png?raw=true
   :alt: Test-Suite
...
.. image:: https://github.com/khulnasoft/khulnasoft.github.io/blob/main/img/externally_linked/deep_dive/continuous_integration/pull-request1.png?raw=true
   :alt: PR Test-Suite
