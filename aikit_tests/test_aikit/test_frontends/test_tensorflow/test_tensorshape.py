...
from aikit_tests.test_aikit.helpers import handle_frontend_method
import pytest

CLASS_TREE = "aikit.functional.frontends.tensorflow.tensor.TensorShape"
...
def test_tensorflow__add__(
    ...
    helpers.test_frontend_method(
        init_input_dtypes=[aikit.int64],
        backend_to_test=backend_fw,
        init_all_as_kwargs_np={
            "dims": shape_list,
        },
        method_input_dtypes=[aikit.int64],
