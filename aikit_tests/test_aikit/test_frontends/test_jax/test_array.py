...
from aikit_tests.test_aikit.test_frontends.test_jax.test_numpy.test_manipulations import (
    _get_input_and_reshape,
)

CLASS_TREE = "aikit.functional.frontends.jax.numpy.ndarray"
...
def test_jax_array_at(x_y_index, backend_fw):
    with BackendHandler.update_backend(backend_fw) as aikit_backend:
        jax_frontend = aikit_backend.utils.dynamic_import.import_module(
            "aikit.functional.frontends.jax"
        )
        xy, idx = x_y_index
