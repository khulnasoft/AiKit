...
from aikit.functional.frontends.paddle import Tensor
from aikit_tests.test_aikit.helpers import assert_all_close
from aikit_tests.test_aikit.helpers import handle_frontend_method, BackendHandler
from aikit_tests.test_aikit.test_functional.test_experimental.test_core.test_manipulation import (  # noqa E501
...
from aikit_tests.test_aikit.test_frontends.test_paddle.test_manipulation import (
    _tile_helper,
)

CLASS_TREE = "aikit.functional.frontends.paddle.Tensor"
...
def test_paddle_device(
    ...
    aikit.utils.assertions.check_equal(
        x.place, aikit.dev(aikit.array(data[0])), as_array=False
    )
...
def test_paddle_eigvals(
    ...
    with BackendHandler.update_backend(backend_fw) as aikit_backend:
        # check if Tensor or aikit array
        try:
            ret = ret.aikit_array.to_numpy()
        except AttributeError:
            ret = aikit_backend.to_numpy(ret)
