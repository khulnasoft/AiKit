...
from aikit import set_exception_trace_mode
from aikit_tests.test_aikit.helpers import globals as test_globals
from aikit_tests.test_aikit.helpers.available_frameworks import available_frameworks  # noqa
from aikit_tests.test_aikit.helpers.multiprocessing import backend_proc, frontend_proc
...
if "ARRAY_API_TESTS_MODULE" not in os.environ:
    os.environ["ARRAY_API_TESTS_MODULE"] = "aikit.functional.backends.numpy"
...
def pytest_addoption(parser):
    ...
    parser.addoption(
        ...
        action="store_true",
        default=False,
        help="Force the testing pipeline to use aikit.set_backend for backend setting",
    )
