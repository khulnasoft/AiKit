...
@handle_test(
    fn_tree="functional.aikit.experimental.hinge_embedding_loss",
...
# huber_loss
@handle_test(
    fn_tree="functional.aikit.experimental.huber_loss",
...
# kl_div
@handle_test(
    fn_tree="functional.aikit.experimental.kl_div",
...
@handle_test(
    fn_tree="functional.aikit.experimental.l1_loss",
...
# log_poisson_loss
@handle_test(
    fn_tree="functional.aikit.experimental.log_poisson_loss",
...
# poisson_nll_loss
@handle_test(
    fn_tree="functional.aikit.experimental.poisson_nll_loss",
...
@handle_test(
    fn_tree="functional.aikit.experimental.smooth_l1_loss",
    dtype_and_input=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=-10.0,
        max_value=10.0,
...
# soft_margin_loss
@handle_test(
    fn_tree="functional.aikit.experimental.soft_margin_loss",
    dtype_and_input=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=1e-04,
        max_value=1,
