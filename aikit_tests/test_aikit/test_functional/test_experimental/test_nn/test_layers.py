...
def _get_reduce_func(dtype):
    if dtype == "bool":
        return st.sampled_from([aikit.logical_and, aikit.logical_or])
    else:
        return st.sampled_from([aikit.add, aikit.maximum, aikit.minimum, aikit.multiply])


@st.composite
def _interp_args(draw, mode=None, mode_list=None):
    mixed_fn_compos = draw(st.booleans())
    curr_backend = aikit.current_backend_str()
    torch_modes = [
        "linear",
        "bilinear",
        "trilinear",
...
@handle_test(
    fn_tree="functional.aikit.experimental.adaptive_avg_pool1d",
...
@handle_test(
    fn_tree="functional.aikit.experimental.adaptive_avg_pool2d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_num_dims=3,
        max_num_dims=4,
...
@handle_test(
    fn_tree="functional.aikit.experimental.adaptive_max_pool2d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_num_dims=3,
        max_num_dims=4,
...
@handle_test(
    fn_tree="functional.aikit.experimental.avg_pool1d",
...
# avg_pool2d
@handle_test(
    fn_tree="functional.aikit.experimental.avg_pool2d",
...
@handle_test(
    fn_tree="functional.aikit.experimental.avg_pool3d",
...
# dropout1d
@handle_test(
    fn_tree="functional.aikit.experimental.dropout1d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=0,
        max_value=50,
...
@handle_test(
    fn_tree="functional.aikit.experimental.dropout2d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=0,
        max_value=50,
...
# dropout3d
@handle_test(
    fn_tree="functional.aikit.experimental.dropout3d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=0,
        max_value=50,
...
# embedding
@handle_test(
    fn_tree="functional.aikit.experimental.embedding",
...
@handle_test(
    fn_tree="functional.aikit.experimental.fft",
...
@handle_test(
    fn_tree="functional.aikit.experimental.fft2",
...
@handle_test(
    fn_tree="functional.aikit.experimental.ifft",
...
@handle_test(
    fn_tree="functional.aikit.experimental.ifftn",
...
@handle_test(
    fn_tree="functional.aikit.experimental.interpolate",
...
@handle_test(
    fn_tree="functional.aikit.experimental.max_pool1d",
...
@handle_test(
    fn_tree="functional.aikit.experimental.max_pool2d",
    x_k_s_p=helpers.arrays_for_pooling(
        min_dims=4,
        max_dims=4,
        min_side=2,
...
@handle_test(
    fn_tree="functional.aikit.experimental.max_pool3d",
    x_k_s_p=helpers.arrays_for_pooling(
        min_dims=5,
        max_dims=5,
        min_side=1,
...
@handle_test(
    fn_tree="functional.aikit.experimental.max_unpool1d",
...
@handle_test(
    fn_tree="functional.aikit.experimental.reduce_window",
...
@handle_test(
    fn_tree="functional.aikit.experimental.rfft",
...
@handle_test(
    fn_tree="functional.aikit.experimental.rfftn",
...
# test_rnn
@handle_test(
    fn_tree="functional.aikit.experimental.rnn",
    ...
    def _lstm_step(cell_inputs, cell_states):
        with BackendHandler.update_backend(
            aikit.current_backend(
                ...
                if "aikit" in str(type(cell_inputs))
                else cell_inputs
            ).backend
        ) as aikit_backend:
            nonlocal kernel_orig, recurrent_kernel_orig, bias_orig, recurrent_bias_orig
            kernel = aikit_backend.array(kernel_orig)
            recurrent_kernel = aikit_backend.array(recurrent_kernel_orig)
            bias = aikit_backend.array(bias_orig)
            recurrent_bias = aikit_backend.array(recurrent_bias_orig)

            h_tm1 = cell_states[0]  # previous memory state
            c_tm1 = cell_states[1]  # previous carry state

            z = aikit_backend.dot(cell_inputs, kernel) + bias
            z += aikit_backend.dot(h_tm1, recurrent_kernel) + recurrent_bias

            z0, z1, z2, z3 = aikit_backend.split(z, num_or_size_splits=4, axis=-1)

            i = aikit_backend.sigmoid(z0)  # input
            f = aikit_backend.sigmoid(z1)  # forget
            c = f * c_tm1 + i * aikit_backend.tanh(z2)
            o = aikit_backend.sigmoid(z3)  # output

            h = o * aikit_backend.tanh(c)
            return h, [h, c]
...
@handle_test(
    fn_tree="functional.aikit.experimental.sliding_window",
...
# test_stft
@handle_test(
    fn_tree="functional.aikit.experimental.stft",
