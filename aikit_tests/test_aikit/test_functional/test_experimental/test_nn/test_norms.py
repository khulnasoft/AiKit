...
# batch_norm
@handle_test(
    fn_tree="functional.aikit.experimental.batch_norm",
...
# group_norm
@handle_test(
    fn_tree="functional.aikit.experimental.group_norm",
...
@handle_test(
    fn_tree="functional.aikit.experimental.instance_norm",
...
@handle_test(
    fn_tree="functional.aikit.experimental.l1_normalize",
...
# local_response_norm
@handle_test(
    fn_tree="functional.aikit.experimental.local_response_norm",
