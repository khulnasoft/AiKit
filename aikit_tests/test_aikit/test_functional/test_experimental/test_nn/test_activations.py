...
# celu
@handle_test(
    fn_tree="functional.aikit.experimental.celu",
...
# elu
@handle_test(
    fn_tree="functional.aikit.experimental.elu",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# hardshrink
@handle_test(
    fn_tree="functional.aikit.experimental.hardshrink",
    dtype_and_x=helpers.dtype_and_values(
...
# hardtanh
@handle_test(
    fn_tree="functional.aikit.experimental.hardtanh",
    dtype_and_x=helpers.dtype_and_values(
...
# logit
@handle_test(
    fn_tree="functional.aikit.experimental.logit",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# logsigmoid
@handle_test(
    fn_tree="functional.aikit.experimental.logsigmoid",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        safety_factor_scale="log",
...
# relu6
@handle_test(
    fn_tree="functional.aikit.experimental.relu6",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
...
# scaled_tanh
@handle_test(
    fn_tree="functional.aikit.experimental.scaled_tanh",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        min_dim_size=1,
        min_num_dims=1,
...
# selu
@handle_test(
    fn_tree="functional.aikit.experimental.selu",
...
# silu
@handle_test(
    fn_tree="functional.aikit.experimental.silu",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# softshrink
@handle_test(
    fn_tree="functional.aikit.experimental.softshrink",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# tanhshrink
@handle_test(
    fn_tree="functional.aikit.experimental.tanhshrink",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# threshold
@handle_test(
    fn_tree="functional.aikit.experimental.threshold",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# thresholded_relu
@handle_test(
    fn_tree="functional.aikit.experimental.thresholded_relu",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
