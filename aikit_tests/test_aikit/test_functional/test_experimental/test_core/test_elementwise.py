...
def _float_power_helper(draw, *, available_dtypes=None):
    ...
    if aikit.is_int_dtype(dtype2[0]):
        min_value = 0
    else:
        min_value = -10
    dtype2, x2 = draw(
...
# allclose
@handle_test(
    fn_tree="functional.aikit.experimental.allclose",
...
@handle_test(
    fn_tree="functional.aikit.experimental.amax",
...
@handle_test(
    fn_tree="functional.aikit.experimental.amin",
    dtype_and_x=helpers.dtype_values_axis(
        available_dtypes=helpers.get_dtypes("valid"),
        large_abs_safety_factor=2,
        small_abs_safety_factor=2,
...
@handle_test(
    fn_tree="functional.aikit.experimental.binarizer",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
...
# copysign
@handle_test(
    fn_tree="functional.aikit.experimental.copysign",
...
# count_nonzero
@handle_test(
    fn_tree="functional.aikit.experimental.count_nonzero",
...
# diff
@handle_test(
    fn_tree="functional.aikit.experimental.diff",
...
# digamma
@handle_test(
    fn_tree="functional.aikit.experimental.digamma",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=-10,
        max_value=10,
...
# erfc
@handle_test(
    fn_tree="functional.aikit.experimental.erfc",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
    ),
    test_with_out=st.just(False),
...
# fix
@handle_test(
    fn_tree="functional.aikit.experimental.fix",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_num_dims=1,
        max_num_dims=3,
...
# float_power
@handle_test(
    fn_tree="functional.aikit.experimental.float_power",
...
# fmax
@handle_test(
    fn_tree="functional.aikit.experimental.fmax",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        large_abs_safety_factor=4,
        small_abs_safety_factor=4,
...
# frexp
@handle_test(
    fn_tree="functional.aikit.experimental.frexp",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=["float32", "float64"],
        num_arrays=1,
        shared_dtype=True,
...
# gradient
@handle_test(
    fn_tree="functional.aikit.experimental.gradient",
    dtype_n_x_n_axis=helpers.dtype_values_axis(
        available_dtypes=helpers.get_dtypes("valid"),
        min_num_dims=1,
        max_num_dims=3,
...
# hypot
@handle_test(
    fn_tree="functional.aikit.experimental.hypot",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        num_arrays=2,
        shared_dtype=True,
...
# isclose
@handle_test(
    fn_tree="functional.aikit.experimental.isclose",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        large_abs_safety_factor=4,
        small_abs_safety_factor=4,
...
@handle_test(
    fn_tree="functional.aikit.experimental.ldexp",
...
# lerp
@handle_test(
    fn_tree="functional.aikit.experimental.lerp",
...
# lgamma
@handle_test(
    fn_tree="functional.aikit.experimental.lgamma",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        safety_factor_scale="log",
    ),
...
# modf
@handle_test(
    fn_tree="functional.aikit.experimental.modf",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        num_arrays=1,
        min_value=0,
...
# nansum
@handle_test(
    fn_tree="functional.aikit.experimental.nansum",
...
# nextafter
@handle_test(
    fn_tree="functional.aikit.experimental.nextafter",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=["float32", "float64"],
        num_arrays=2,
        shared_dtype=True,
...
# sinc
@handle_test(
    fn_tree="functional.aikit.experimental.sinc",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        large_abs_safety_factor=4,
        small_abs_safety_factor=4,
...
# sparsify_tensor
@handle_test(
    fn_tree="functional.aikit.experimental.sparsify_tensor",
...
# xlogy
@handle_test(
    fn_tree="functional.aikit.experimental.xlogy",
    dtype_and_x=helpers.dtype_and_values(
...
# zeta
@handle_test(
    fn_tree="functional.aikit.experimental.zeta",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        num_arrays=2,
        shared_dtype=True,
