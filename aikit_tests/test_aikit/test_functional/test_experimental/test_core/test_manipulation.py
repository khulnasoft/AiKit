...
from aikit_tests.test_aikit.helpers import handle_test, create_concatenable_arrays_dtypes
from aikit.functional.aikit.experimental.manipulation import _check_bounds
from aikit_tests.test_aikit.test_functional.test_core.test_manipulation import _get_splits
...
def _fold_data(draw):
    ...
    reduced_dims = int(aikit.prod(shape[0:mode]) * aikit.prod(shape[mode + 1 :]))
...
def _partial_fold_data(draw):
    ...
    if skip_end != 0:
        reduced_dims = int(
            aikit.prod(shape[skip_begin : skip_begin + mode])
            * aikit.prod(shape[skip_begin + mode + 1 : -skip_end])
        )
        unfolded_shape = (
            *shape[:skip_begin],
        ...
        reduced_dims = int(
            aikit.prod(shape[skip_begin : skip_begin + mode])
            * aikit.prod(shape[skip_begin + mode + 1 :])
        )
...
# associative_scan
@handle_test(
    fn_tree="functional.aikit.experimental.associative_scan",
    dtype_elems_axis=_associative_scan_helper(),
    fn=st.sampled_from([aikit.matmul, aikit.multiply, aikit.add]),
    reverse=st.booleans(),
    test_with_out=st.just(False),
...
# atleast_1d
@handle_test(
    fn_tree="functional.aikit.experimental.atleast_1d",
...
# atleast_2d
@handle_test(
    fn_tree="functional.aikit.experimental.atleast_2d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        num_arrays=helpers.ints(min_value=1, max_value=5),
    ),
...
@handle_test(
    fn_tree="functional.aikit.experimental.atleast_3d",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        num_arrays=helpers.ints(min_value=1, max_value=5),
        shared_dtype=True,
...
# broadcast_shapes
@handle_test(
    fn_tree="functional.aikit.experimental.broadcast_shapes",
...
# column_stack
@handle_test(
    fn_tree="functional.aikit.experimental.column_stack",
...
@handle_test(
    fn_tree="functional.aikit.experimental.concat_from_sequence",
...
# dsplit
@handle_test(
    fn_tree="functional.aikit.experimental.dsplit",
    test_with_copy=st.just(True),
)
def test_dsplit(
...
# dstack
@handle_test(
    fn_tree="functional.aikit.experimental.dstack",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        shared_dtype=True,
...
@handle_test(
    fn_tree="functional.aikit.experimental.flatten",
...
# fliplr
@handle_test(
    fn_tree="functional.aikit.experimental.fliplr",
...
# flipud
@handle_test(
    fn_tree="functional.aikit.experimental.flipud",
    dtype_and_m=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        min_value=-100,
        max_value=100,
...
@handle_test(
    fn_tree="functional.aikit.experimental.fold",
    data=_fold_data(),
)
...
# heaviside
@handle_test(
    fn_tree="functional.aikit.experimental.heaviside",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=-100,
        max_value=100,
...
@handle_test(
    fn_tree="functional.aikit.experimental.hsplit",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
...
# hstack
@handle_test(
    fn_tree="functional.aikit.experimental.hstack",
    dtype_and_m=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        shared_dtype=True,
...
# i0
@handle_test(
    fn_tree="functional.aikit.experimental.i0",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=-10,
        max_value=10,
...
@handle_test(
    fn_tree="functional.aikit.experimental.matricize",
...
# moveaxis
@handle_test(
    fn_tree="functional.aikit.experimental.moveaxis",
...
@handle_test(
    fn_tree="functional.aikit.experimental.pad",
    ground_truth_backend="numpy",
...
@handle_test(
    fn_tree="functional.aikit.experimental.partial_fold",
...
@handle_test(
    fn_tree="functional.aikit.experimental.partial_tensor_to_vec",
...
@handle_test(
    fn_tree="functional.aikit.experimental.partial_unfold",
...
@handle_test(
    fn_tree="functional.aikit.experimental.partial_vec_to_tensor",
...
# put_along_axis
@handle_test(
    fn_tree="functional.aikit.experimental.put_along_axis",
...
# rot90
@handle_test(
    fn_tree="functional.aikit.experimental.rot90",
...
@handle_test(
    fn_tree="functional.aikit.experimental.soft_thresholding",
...
@handle_test(
    fn_tree="functional.aikit.experimental.take",
...
# take_along_axis
@handle_test(
    fn_tree="functional.aikit.experimental.take_along_axis",
    dtype_x_indices_axis=helpers.array_indices_axis(
        array_dtypes=helpers.get_dtypes("valid"),
        indices_dtypes=["int32", "int64"],
        min_num_dims=1,
...
# top_k
@handle_test(
    fn_tree="functional.aikit.experimental.top_k",
...
@handle_test(
    fn_tree="functional.aikit.experimental.unfold",
...
# vsplit
@handle_test(
    fn_tree="functional.aikit.experimental.vsplit",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        shape=st.shared(helpers.get_shape(min_num_dims=2), key="value_shape"),
    ),
...
# vstack
@handle_test(
    fn_tree="functional.aikit.experimental.vstack",
