...
# hardswish
@handle_test(
    fn_tree="functional.aikit.hardswish",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
...
# leaky_relu
@handle_test(
    fn_tree="functional.aikit.leaky_relu",
    dtype_and_x=helpers.dtype_and_values(
...
# log_softmax
@handle_test(
    fn_tree="functional.aikit.log_softmax",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        min_num_dims=2,
...
# sigmoid
@handle_test(
    fn_tree="functional.aikit.sigmoid",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# softmax
@handle_test(
    fn_tree="functional.aikit.softmax",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        min_num_dims=1,
        large_abs_safety_factor=8,
...
# softplus
@handle_test(
    fn_tree="functional.aikit.softplus",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        min_num_dims=1,
