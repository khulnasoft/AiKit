...
# concat
@handle_test(
    fn_tree="functional.aikit.concat",
...
# constant_pad
@handle_test(
    fn_tree="functional.aikit.constant_pad",
...
# expand_dims
@handle_test(
    fn_tree="functional.aikit.expand_dims",
...
# permute_dims
@handle_test(
    fn_tree="functional.aikit.permute_dims",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
# repeat
@handle_test(
    fn_tree="functional.aikit.repeat",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
@handle_test(
    fn_tree="functional.aikit.reshape",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(), key="value_shape"),
    ),
...
@handle_test(
    fn_tree="functional.aikit.split",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
# squeeze
@handle_test(
    fn_tree="functional.aikit.squeeze",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(), key="value_shape"),
    ),
...
# stack
@handle_test(
    fn_tree="functional.aikit.stack",
...
# swapaxes
@handle_test(
    fn_tree="functional.aikit.swapaxes",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
...
# unstack
@handle_test(
    fn_tree="functional.aikit.unstack",
...
# zero_pad
@handle_test(
    fn_tree="functional.aikit.zero_pad",
