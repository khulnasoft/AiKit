...
# cumprod
@handle_test(
    fn_tree="functional.aikit.cumprod",
...
@handle_test(
    fn_tree="functional.aikit.cumsum",
    dtype_x_axis_castable=_get_castable_dtype(),
    exclusive=st.booleans(),
    reverse=st.booleans(),
)
...
# einsum
@handle_test(
    fn_tree="functional.aikit.einsum",
