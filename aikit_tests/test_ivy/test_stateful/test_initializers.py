...
def test_constant(
    ...
    ret_aikit, ret_gt = helpers.test_method(
    ...
    assert ret_aikit.shape == ret_gt.shape
    assert ret_aikit.dtype == ret_gt.dtype
    assert aikit.all(aikit.equal(ret_aikit, aikit.array(constant)))
...
def test_first_layer_siren(
    ...
    assert ret_aikit.shape == ret_gt.shape
    assert ret_aikit.dtype == ret_gt.dtype
    assert aikit.all(aikit.less(aikit.abs(ret_aikit), aikit.array(bound)))
...
def test_ones(
    ...
    assert ret_aikit.shape == ret_gt.shape
    assert ret_aikit.dtype == ret_gt.dtype
    assert aikit.all(aikit.equal(ret_aikit, aikit.array(1.0)))
...
def test_zeros(
    ...
    assert ret_aikit.shape == ret_gt.shape
    assert ret_aikit.dtype == ret_gt.dtype
    assert aikit.all(aikit.equal(ret_aikit, aikit.array(0.0)))
