...
import contextlib
import pytest
from aikit.utils.assertions import (
    check_all,
    check_all_or_any_fn,
    check_any,
...
from aikit.utils.assertions import _check_jax_x64_flag
import aikit
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        ((1, 2, 0), aikit.array, "all", [3]),
        ((0, 0), aikit.array, "all", [2]),
        ((1, 1), aikit.array, "any", [3]),
        ((0, 0, 1), aikit.array, "any", [3]),
        ((1, 0, 1), aikit.array, "all_any", [3]),
        # VALID
        ((1, 1), aikit.array, "any", [2]),
        ((0, 1), aikit.array, "any", [1]),
        ((1, 1, 2), aikit.array, "all", [3]),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (aikit.array([1, 2, 3]), aikit.array([1]), 2, 3),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([[0], [2]]), 1, 2),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([[0, 1], [1, 2], [2, 3]]), 1, 0),
        (aikit.array([1, 2, 3]), aikit.array([[1, 2]]), 1, 0),
        # VALID
        (aikit.array([1, 2, 3]), aikit.array([1]), 0, 1),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([0, 2]), -1, 0),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([[0, 1], [1, 2]]), -1, 0),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (aikit.array([1, 2, 3]), aikit.array([1]), 2),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([0, 2]), 1),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([[0, 1], [1, 2], [2, 3]]), 1),
        (aikit.array([1, 2, 3]), aikit.array([[1, 2]]), 0),
        # VALID
        (aikit.array([1, 2, 3]), aikit.array([1]), 0),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([0, 2]), 0),
        (aikit.array([[1, 2, 3], [4, 5, 6]]), aikit.array([[0, 1], [1, 2]]), 1),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (aikit.array([1]), aikit.array([1, 2])),
        (aikit.array([[1], [1], [2]]), aikit.array([1, 2])),
        # VALID
        (aikit.array([1, 2]), aikit.array([1])),
        (aikit.array([[[1]]]), aikit.array([1, 2])),
    ],
)
...
@pytest.mark.parametrize(
    ("x", "allowed_types"),
    [(5.0, float), (aikit.array(5), type(aikit.array(8))), (5, float), ([5, 10], tuple)],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (aikit.array([1.0, 2.0, 3.0]), aikit.array([4, 5, 6])),
        (aikit.array([1, 2, 3]), aikit.array([4j, 5 + 1j, 6])),
        (aikit.array([1j]), aikit.array([2, 3 + 4j])),
    ],
)
...
@pytest.mark.parametrize(
    ("x1", "x2"),
    [
        (aikit.array([1, 2, 3]), aikit.array([[4, 5, 6], [2, 3, 1]])),
        (aikit.array([[1.0, 2.0], [3.0, 4.0]]), aikit.array([4, 5, 6])),
        (aikit.array([1, 2]), aikit.array([3, 4, 5])),
        (aikit.array([1]), aikit.array([2])),
        (aikit.array([1, 2]), aikit.array([2, 3])),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (aikit.array([1, 2, 3]), aikit.array([0, 1, 0], dtype=aikit.int32), 2.0),
        (aikit.array([1, 2, 3]), aikit.array([0, 1, 0], dtype=aikit.int32), 0),
        (aikit.array([1, 2, 3]), aikit.array([0, 1, 0], dtype=aikit.int32), -2),
        (aikit.array([1, 2, 3]), aikit.array([0.0, 1.0, 0.0], dtype=aikit.float16), 0),
        (aikit.array([1, 2]), aikit.array([0, 1, 0], dtype=aikit.int32), 0),
        (aikit.array([1, 2, 3]), aikit.array([0, 1], dtype=aikit.int32), 0),
        (aikit.array([1, 2, 3]), aikit.array([0, 1, 2], dtype=aikit.int32), 2),
        # VALID
        (
            aikit.array([1, 2, 3]),
            aikit.array([0, 1, 0], dtype=aikit.int32),
            2,
        ),
        (aikit.array([1, 2, 3]), aikit.array([0, 1, 0], dtype=aikit.int32), aikit.array([2])),
    ],
)
