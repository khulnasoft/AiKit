...
@handle_test(
    fn_tree="functional.aikit.argmax",
...
@handle_test(
    fn_tree="functional.aikit.argmin",
    dtype_x_axis=_dtype_x_limited_axis(allow_none=True),
    keepdims=st.booleans(),
...
# argwhere
@handle_test(
    fn_tree="functional.aikit.argwhere",
...
@handle_test(
    fn_tree="functional.aikit.nonzero",
...
@handle_test(
    fn_tree="functional.aikit.where",
