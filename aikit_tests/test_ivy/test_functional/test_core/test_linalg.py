...
from aikit_tests.test_aikit.helpers.hypothesis_helpers.general_helpers import (
    matrix_is_stable,
)
...
@handle_test(
    fn_tree="functional.aikit.cholesky",
...
# cross
@handle_test(
    fn_tree="functional.aikit.cross",
...
# diagonal
@handle_test(
    fn_tree="functional.aikit.diagonal",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        min_num_dims=2,
        max_num_dims=2,
...
# eigvalsh
@handle_test(
    fn_tree="functional.aikit.eigvalsh",
    dtype_x=_get_dtype_and_matrix(symmetric=True),
    UPLO=st.sampled_from(("L", "U")),
    test_gradients=st.just(False),
)
...
# inner
@handle_test(
    fn_tree="functional.aikit.inner",
...
# matmul
@handle_test(
    fn_tree="functional.aikit.matmul",
...
# matrix_norm
@handle_test(
    fn_tree="functional.aikit.matrix_norm",
...
# matrix_power
@handle_test(
    fn_tree="functional.aikit.matrix_power",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=1e-3,
        max_value=20,
...
# matrix_rank
@handle_test(
    fn_tree="functional.aikit.matrix_rank",
...
# matrix_transpose
@handle_test(
    fn_tree="functional.aikit.matrix_transpose",
...
# outer
@handle_test(
    fn_tree="functional.aikit.outer",
    dtype_xy=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        min_value=1,
...
# execute with grads error
@handle_test(
    fn_tree="functional.aikit.slogdet",
    dtype_x=_det_helper(),
    test_with_out=st.just(False),
)
...
@handle_test(
    fn_tree="functional.aikit.solve",
...
# svdvals
@handle_test(
    fn_tree="functional.aikit.svdvals",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=0,
        max_value=50,
...
# tensordot
@handle_test(
    fn_tree="functional.aikit.tensordot",
...
# trace
@handle_test(
    fn_tree="functional.aikit.trace",
...
# vander
@handle_test(
    fn_tree="functional.aikit.vander",
...
# vecdot
@handle_test(
    fn_tree="functional.aikit.vecdot",
    dtype_x1_x2_axis=dtype_value1_value2_axis(
        available_dtypes=helpers.get_dtypes("numeric"),
...
# vector_norm
@handle_test(
    fn_tree="functional.aikit.vector_norm",
...
def test_vector_norm(
    *, dtype_values_axis, kd, ord, dtype, test_flags, backend_fw, fn_name, on_device
    ...
    with BackendHandler.update_backend(backend_fw) as aikit_backend:
        arr = aikit_backend.array([[1.0, 2.0, 3.0], [-1.0, 2.0, 4.0]])
        arr_normed_inf = aikit_backend.vector_norm(arr, axis=0, ord=float("inf"))
        arr_normed_min_inf = aikit_backend.vector_norm(arr, axis=0, ord=float("-inf"))
...
@handle_test(
    fn_tree="functional.aikit.vector_to_skew_symmetric_matrix",
