...
def valid_unsorted_segment_min_inputs(draw):
    while True:
        dtype = draw(st.sampled_from([aikit.int32, aikit.int64, aikit.float32, aikit.float64]))
        ...
        if data.shape[0] == segment_ids.shape[0]:
            if np.max(segment_ids) < num_segments:
                return (dtype, aikit.int32), data, num_segments, segment_ids
...
# eye_like
@handle_test(
    fn_tree="functional.aikit.experimental.eye_like",
...
# hamming_window
@handle_test(
    fn_tree="functional.aikit.experimental.hamming_window",
    dtype_and_x=helpers.dtype_and_values(
...
# hann_window
@handle_test(
    fn_tree="functional.aikit.experimental.hann_window",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("integer"),
        max_num_dims=0,
        min_value=1,
...
# indices
@handle_test(
    fn_tree="functional.aikit.experimental.indices",
...
@handle_test(
    fn_tree="functional.aikit.experimental.kaiser_bessel_derived_window",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("integer"),
        max_num_dims=0,
        min_value=1,
...
# kaiser_window
@handle_test(
    fn_tree="functional.aikit.experimental.kaiser_window",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("integer"),
        max_num_dims=0,
        min_value=1,
...
# mel_weight_matrix
@handle_test(
    fn_tree="functional.aikit.experimental.mel_weight_matrix",
...
# ndenumerate
@handle_test(
    fn_tree="functional.aikit.experimental.ndenumerate",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        min_num_dims=1,
    ),
...
def test_ndenumerate(dtype_and_x):
    ...
    for (index1, x1), (index2, x2) in zip(
        np.ndenumerate(values), aikit.ndenumerate(values)
    ):
...
# ndindex
@handle_test(
    fn_tree="functional.aikit.experimental.ndindex",
...
def test_ndindex(dtype_x_shape):
    ...
    for index1, index2 in zip(np.ndindex(shape), aikit.ndindex(shape)):
        assert index1 == index2


# polyval
@handle_test(
    fn_tree="functional.aikit.experimental.polyval",
...
@handle_test(
    fn_tree="functional.aikit.experimental.random_cp",
...
@handle_test(
    fn_tree="functional.aikit.experimental.random_tr",
...
# @handle_test(
#     fn_tree="functional.aikit.experimental.random_parafac2",
...
@handle_test(
    fn_tree="functional.aikit.experimental.random_tt",
...
@handle_test(
    fn_tree="functional.aikit.experimental.random_tucker",
...
@handle_test(
    fn_tree="functional.aikit.experimental.tril_indices",
...
@handle_test(
    fn_tree="functional.aikit.experimental.trilu",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        min_num_dims=2,
        max_num_dims=5,
...
@handle_test(
    fn_tree="functional.aikit.experimental.unsorted_segment_mean",
...
@handle_test(
    fn_tree="functional.aikit.experimental.unsorted_segment_min",
    d_x_n_s=valid_unsorted_segment_min_inputs(),
    test_with_out=st.just(False),
    test_gradients=st.just(False),
)
...
@handle_test(
    fn_tree="functional.aikit.experimental.unsorted_segment_sum",
    d_x_n_s=valid_unsorted_segment_min_inputs(),
    test_with_out=st.just(False),
    test_gradients=st.just(False),
)
...
# vorbis_window
@handle_test(
    fn_tree="functional.aikit.experimental.vorbis_window",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("integer"),
        max_num_dims=0,
        min_value=1,
