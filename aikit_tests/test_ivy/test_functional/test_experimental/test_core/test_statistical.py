...
@handle_test(
    fn_tree="functional.aikit.experimental.bincount",
...
# corrcoef
@handle_test(
    fn_tree="functional.aikit.experimental.corrcoef",
...
@handle_test(
    fn_tree="functional.aikit.experimental.cummax",
...
# cummin
@handle_test(
    fn_tree="functional.aikit.experimental.cummin",
    dtype_x_axis_castable=_get_castable_dtype(),
    exclusive=st.booleans(),
    reverse=st.booleans(),
)
...
@handle_test(
    fn_tree="functional.aikit.experimental.histogram",
...
# igamma
@handle_test(
    fn_tree="functional.aikit.experimental.igamma",
    dtype_and_x=helpers.dtype_and_values(
...
@handle_test(
    fn_tree="functional.aikit.experimental.median",
...
# nanmean
@handle_test(
    fn_tree="functional.aikit.experimental.nanmean",
...
# nanmedian
@handle_test(
    fn_tree="functional.aikit.experimental.nanmedian",
...
@handle_test(
    fn_tree="functional.aikit.experimental.nanmin",
...
@handle_test(
    fn_tree="functional.aikit.experimental.nanprod",
    dtype_x_axis_castable=_get_castable_float_dtype_nan(),
    keep_dims=st.booleans(),
    test_gradients=st.just(False),
    initial=st.integers(min_value=-5, max_value=5),
...
# quantile
@handle_test(
    fn_tree="functional.aikit.experimental.quantile",
