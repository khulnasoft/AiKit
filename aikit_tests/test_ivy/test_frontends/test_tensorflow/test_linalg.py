...
from aikit_tests.test_aikit.helpers import handle_frontend_test, assert_all_close
...
def tridiagonal_compact_filter(x):
    ...
    matrix = aikit.scatter_nd(
        indices, diagonals, aikit.array([dim, dim]), reduction="replace"
    )
