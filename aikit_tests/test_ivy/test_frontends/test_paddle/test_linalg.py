...
from aikit_tests.test_aikit.helpers import handle_frontend_test, matrix_is_stable
from aikit_tests.test_aikit.test_functional.test_core.test_linalg import (
    _get_dtype_and_matrix,
)

from aikit_tests.test_aikit.test_frontends.test_tensorflow.test_linalg import (
    _get_second_matrix,
...
def _dtype_values_axis(draw):
    ...
    p_list = ["fro", 1, 2, aikit.inf, -aikit.inf]
