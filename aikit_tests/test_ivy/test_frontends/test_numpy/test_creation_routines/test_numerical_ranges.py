...
# local
from aikit.functional.frontends.numpy import mgrid, ogrid
import aikit_tests.test_aikit.helpers as helpers
from aikit_tests.test_aikit.helpers import handle_frontend_test, handle_frontend_method
...
def test_numpy_arange(
    ...
    helpers.test_frontend_function(
        input_dtypes=[aikit.as_aikit_dtype("int8")],
        frontend=frontend,
...
@handle_frontend_method(
    class_tree="aikit.functional.frontends.numpy.mgrid",
...
# ogrid
@handle_frontend_method(
    class_tree="aikit.functional.frontends.numpy.ogrid",
