...
# local
import aikit
from aikit.functional.aikit.layers import _get_embed_dim
from aikit.functional.frontends.torch.nn.functional.layer_functions import (
    _pack_padded_sequence,
)
from aikit_tests.test_aikit import helpers
from aikit_tests.test_aikit.helpers import handle_frontend_test
from aikit_tests.test_aikit.test_functional.test_nn.test_layers import _mha_helper
...
def test_torch_multi_head_attention_forward(
    *,
    ...
    # of aikit.multi_head_attention's arguments given by _mha_helper
    kwargs = {
        "query": q,
        "key": k,
        "value": v,
    ...
    helpers.test_frontend_function(
        input_dtypes=[str(r.dtype) for r in kwargs.values() if aikit.is_array(r)],
        backend_to_test=backend_fw,
        frontend=frontend,
        test_flags=test_flags,
        fn_tree=fn_tree,
