...
# local
import aikit
from aikit.stateful.module import Module
...
class GEGLU(Module):
    ...
    def _forward(self, inputs):
        ...
        """
        x, gates = aikit.split(inputs, num_or_size_splits=2, axis=-1)
        return aikit.gelu(gates) * x
...
class ReLU(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.relu(x, complex_mode=self._complex_mode)
...
class LogSoftmax(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.log_softmax(x, axis=self._axis, complex_mode=self._complex_mode)
...
class Softmax(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.softmax(x, axis=self._axis, complex_mode=self._complex_mode)
...
class Softplus(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.softplus(x, beta=self._beta, threshold=self._threshold)
...
class Sigmoid(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.sigmoid(x, complex_mode=self._complex_mode)
...
class Tanh(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.tanh(x, complex_mode=self._complex_mode)
...
class ReLU6(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.relu6(x, complex_mode=self._complex_mode)
...
class Hardswish(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.hardswish(x, complex_mode=self._complex_mode)
...
class PReLU(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.prelu(x, self._slope)
...
class ELU(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.elu(x, alpha=self._alpha)
...
class LogSigmoid(Module):
    ...
    def _forward(self, x):
        ...
        """
        return aikit.logsigmoid(x, complex_mode=self._complex_mode)
