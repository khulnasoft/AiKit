...
class Optimizer(abc.ABC):
    def __init__(
        ...
        self._dev = aikit.default(device, aikit.default_device())
        self._count = aikit.array([0], device=self._dev)
    ...
    @abc.abstractmethod
    def _step(self, v: aikit.Container, grads: aikit.Container):
    ...
    def _step_fn(
        self, v: aikit.Container, grads: aikit.Container, ignore_missing: bool = False
    ):
    ...
    @abc.abstractmethod
    def set_state(self, state: aikit.Container):
...
class LAMB(Optimizer):
    ...
    def _step(self, v: aikit.Container, grads: aikit.Container):
        ...
        new_v, self._mw, self._vw = aikit.lamb_update(
            v,
            grads,
            self._lr if isinstance(self._lr, float) else self._lr(),
            self._mw,
