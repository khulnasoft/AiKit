            ...
            if not os.path.exists(path):
                if initial:
                    ...
                    logging.warning(
                        ...
                        "case, calling aikit.utils.cleanup_and_fetch_binaries() should "
                        "fetch the binaries binaries. Feel free to create an issue on "
                        "https://github.com/khulnasoft/aikit.git in case of the former\n"
                    )
                    logging.warning(
...
def cleanup_and_fetch_binaries(clean=True):
    ...
    if os.path.exists(binaries_path):
        ...
        if terminate:
            ...
            print(
                "Couldn't download all binaries. Try importing aikit to get more "
