...
class _ContainerWithGradients(ContainerBase):
    ...
    def _static_stop_gradient(
        ...
        /,
        *,
        preserve_type: Union[bool, aikit.Container] = True,
        ...
        """aikit.Container static method variant of aikit.stop_gradient. This
        method simply wraps the function, and so the docstring for
        aikit.stop_gradient also applies to this method with minimal changes.
        ...
        ...                      b=aikit.array([3., 4., 5.]))
        >>> y = aikit.Container.static_stop_gradient(x, preserve_type=False)
        >>> print(y)
        {
            a: aikit.array([0., 1., 2.]),
            b: aikit.array([3., 4., 5.])
        ...
        >>> x = aikit.Container(a=aikit.array([0., 1., 2.]),
        ...                      b=aikit.array([3., 4., 5.]))
        >>> aikit.Container.static_stop_gradient(x, preserve_type=True, out=x)
        >>> print(x)
        {
            a: aikit.array([0., 1., 2.]),
            b: aikit.array([3., 4., 5.])
    ...
    def stop_gradient(
        ...
        *,
        ...
        """aikit.Container instance method variant of aikit.stop_gradient. This
        method simply wraps the function, and so the docstring for
        aikit.stop_gradient also applies to this method with minimal changes.
    ...
    def adam_step(
        self: aikit.Container,
        mw: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        vw: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        step: Union[int, float, aikit.Container],
        /,
        *,
        beta1: Union[float, aikit.Container] = 0.9,
        beta2: Union[float, aikit.Container] = 0.999,
        epsilon: Union[float, aikit.Container] = 1e-7,
        out: Optional[aikit.Container] = None,
    ) -> aikit.Container:
        """aikit.Container instance method variant of aikit.adam_step. This method
    ...
    def optimizer_update(
        self: aikit.Container,
        effective_grad: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        lr: Union[float, aikit.Array, aikit.NativeArray, aikit.Container],
        /,
        *,
        stop_gradients: Union[bool, aikit.Container] = True,
        out: Optional[aikit.Container] = None,
    ) -> aikit.Container:
    ...
    def gradient_descent_update(
        self: aikit.Container,
        dcdw: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        lr: Union[float, aikit.Array, aikit.NativeArray, aikit.Container],
        /,
        *,
        stop_gradients: Union[bool, aikit.Container] = True,
        out: aikit.Container = None,
    ) -> aikit.Container:
        """aikit.Container instance method variant of
        aikit.gradient_descent_update. This method simply wraps the function, and
        so the docstring for aikit.gradient_descent_update also applies to this
    ...
    def lars_update(
        ...
        /,
        *,
        decay_lambda: Union[float, aikit.Container] = 0,
        stop_gradients: Union[bool, aikit.Container] = True,
        out: Optional[aikit.Container] = None,
    ):
    ...
    def adam_update(
        ...
        dcdw: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        lr: Union[float, aikit.Array, aikit.NativeArray, aikit.Container],
        mw_tm1: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        vw_tm1: Union[aikit.Array, aikit.NativeArray, aikit.Container],
        step: Union[int, aikit.Container],
        /,
        *,
        beta1: Union[float, aikit.Container] = 0.9,
        beta2: Union[float, aikit.Container] = 0.999,
        ...
        ({
            a: aikit.array([1., 2., 3.]),
            b: aikit.array([4., 5., 6.])
        }, aikit.array([0.1 , 0.02, 0.04]), aikit.array([0.01099, 0.01003, 0.01015]))
    ...
    def lamb_update(
        ...
        *,
        ...
        beta2: Union[float, aikit.Container] = 0.999,
        epsilon: Union[float, aikit.Container] = 1e-7,
        max_trust_ratio: Union[int, float, aikit.Container] = 10,
        decay_lambda: Union[float, aikit.Container] = 0,
        stop_gradients: Union[bool, aikit.Container] = True,
        out: Optional[aikit.Container] = None,
    ) -> aikit.Container:
