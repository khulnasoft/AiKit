...
class _ContainerWithNorms(ContainerBase):
    def layer_norm(
        ...
        normalized_idxs: List[Union[int, aikit.Container]],
        /,
        *,
        scale: Optional[Union[aikit.Array, aikit.NativeArray, aikit.Container]] = None,
        offset: Optional[Union[aikit.Array, aikit.NativeArray, aikit.Container]] = None,
        eps: Union[float, aikit.Container] = 1e-05,
        new_std: Union[float, aikit.Container] = 1.0,
        out: Optional[Union[aikit.Array, aikit.Container]] = None,
    ) -> aikit.Container:
        """aikit.Container instance method variant of aikit.layer_norm. This method
        simply wraps the function, and so the docstring for aikit.layer_norm also
        ...
        >>> print(norm)
        {
            a: aikit.array([-1.62221265, 0.20277636, 1.41943574]),
            b: aikit.array([[-1.83710337, 0., 1.83710337],
                          [-1.83710337, 0., 1.83710337]])
        }
        """
        return aikit.layer_norm(
            self,
            normalized_idxs,
            scale=scale,
            offset=offset,
