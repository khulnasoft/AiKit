...
from aikit.data_classes.container.experimental import (
...
class Container(
    ...
    def __pow__(self, power):
        """aikit.Container special method for the power operator, calling
        ...
        >>> x = aikit.Container(a=aikit.array([0, 1.2]), b=aikit.array([2.2, 3.]))
        >>> y = x ** 3.1
        >>> print(y)
        {
            a: aikit.array([0., 1.75979435]),
            b: aikit.array([11.52153397, 30.13532257])
        }
        """
        if isinstance(power, aikit.Container):
            return aikit.Container.cont_multi_map(
    ...
    def __add__(self, other):
        """aikit.Container special method for the add operator, calling
    ...
    def __radd__(self, other):
        """aikit.Container reverse special method for the add operator, calling
        :code:`operator.add` for each of the corresponding leaves of the two
        containers.
    ...
    def __sub__(self, other):
        """aikit.Container special method for the subtract operator, calling
        ...
        >>> print(z)
        {
            a: aikit.array([[2.9, 1.7, 7.6],
                          [3.9, 2.7, 8.6],
                          [4.9, 3.7, 9.6]]),
            b: aikit.array([[3.9, 2.7, 8.6],
                          [4.9, 3.7, 9.6],
                          [5.9, 4.7, 10.6]])
        }
        """
    ...
    def __rsub__(self, other):
        """aikit.Container reverse special method for the subtract operator,
    ...
    def __truediv__(self, other):
        """aikit.Container special method for the divide operator, calling
        ...
        >>> print(z)
        {
            a: aikit.array([0.25, 0.40000001, 0.5]),
            b: aikit.array([0.66666669, 0.60000002, 0.5])
        }
        """
        return aikit.Container.cont_multi_map(
    ...
    def __floordiv__(self, other):
        if isinstance(other, aikit.Container):
            return aikit.Container.cont_multi_map(
    ...
    def __abs__(self):
        """aikit.Container special method for the abs operator, calling
        ...
        Examples
        --------
        With :class:`aikit.Container` instances:
    ...
    def __lt__(self, other):
        """aikit.Container special method for the less operator, calling
        ...
        >>> y = aikit.Container(a=aikit.array([1, 5, 3]),b=aikit.array([5, 3, 7]))
        >>> z = x < y
        >>> print(z)
        {
    ...
    def __le__(self, other):
        """aikit.Container special method for the less_equal operator, calling
    ...
    def __eq__(self, other):
        """aikit.Container special method for the equal operator, calling
        ...
        ...                    b=aikit.array([1, 4, 5]))
        >>> x2 = aikit.Container(a=aikit.array([1, 3, 3.0]),
    ...
    def __ne__(self, other):
        """aikit.Container special method for the not_equal operator, calling
    ...
    def __gt__(self, other):
        """aikit.Container special method for the greater operator, calling
    ...
    def __ge__(self, other):
        """aikit.Container special method for the greater_equal operator, calling
    ...
    def __xor__(self, other):
        """aikit.Container special method for the ge operator, calling
        :code:`operator.ge` for each of the corresponding leaves of the two
        containers.
        ...
        >>> x = aikit.Container(a=aikit.array([89]), b=aikit.array([2]))
        >>> y = aikit.Container(a=aikit.array([12]), b=aikit.array([3]))
        >>> z = x ^ y
        >>> print(z)
        {
            a: aikit.array([85]),
    ...
    def __rshift__(self, other):
        """aikit.Container special method for the right shift operator, calling
        ...
        >>> x = aikit.Container(a=128, b=43)
        >>> y = aikit.Container(a=5, b=3)
        >>> z = x >> y
        >>> print(z)
        {
            a: 4,
        ...
        >>> x = aikit.Container(a=aikit.array([16, 40, 120]),
        ...                   b=aikit.array([15, 45, 143]))
        >>> y = aikit.Container(a=aikit.array([1, 2, 3]),
        ...                   b=aikit.array([0, 3, 4]))
        >>> z = x >> y
        >>> print(z)
        {
            a: aikit.array([8, 10, 15]),
            b: aikit.array([15, 5, 8])
        }
    ...
    def __rrshift__(self, other):
        """aikit.Container reverse special method for the right shift operator,
