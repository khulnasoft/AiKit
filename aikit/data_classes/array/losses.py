...
class _ArrayWithLosses(abc.ABC):
    def cross_entropy(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.cross_entropy. This method
        simply wraps the function, and so the docstring for aikit.cross_entropy
    ...
    def binary_cross_entropy(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.binary_cross_entropy. This
        ...
        >>> print(z)
        aikit.array([0.357, 0.223, 0.223])
        """
        return aikit.binary_cross_entropy(
            self._data,
            pred,
    ...
    def sparse_cross_entropy(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.sparse_cross_entropy. This
        method simply wraps the function, and so the docstring for
        ...
        >>> print(z)
        aikit.array([0.223, 0.223, 0.357])
        """
        return aikit.sparse_cross_entropy(
            self._data, pred, axis=axis, epsilon=epsilon, reduction=reduction, out=out
        )
