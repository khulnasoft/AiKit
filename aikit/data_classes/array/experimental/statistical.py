...
class _ArrayWithStatisticalExperimental(abc.ABC):
    def histogram(
        ...
        /,
        *,
        bins: Optional[Union[int, aikit.Array, aikit.NativeArray, str]] = None,
        axis: Optional[Union[aikit.Array, aikit.NativeArray]] = None,
        ...
        """aikit.Array instance method variant of aikit.histogram. This method
    ...
    def median(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.median. This method simply
        wraps the function, and so the docstring for aikit.median also applies to
        ...
        """
        return aikit.median(self._data, axis=axis, keepdims=keepdims, out=out)
    ...
    def nanmean(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.nanmean. This method simply
        wraps the function, and so the docstring for aikit.nanmean also applies
    ...
    def nanmin(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.nanmin. This method simply
    ...
    def nanprod(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.nanprod. This method simply
    ...
    def quantile(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.quantile. This method
    ...
    def corrcoef(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.corrcoef. This method
        ...
        >>> a.corrcoef(rowvar=False)
            aikit.array([[ 1., nan, -1.],
                       ...
                       [-1., nan,  1.]])
        """
        return aikit.corrcoef(self._data, y=y, rowvar=rowvar, out=out)
    ...
    def nanmedian(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.nanmedian. This method
        ...
        >>> a = aikit.array([[10.0, aikit.nan, 4], [3, 2, 1]])
        >>> a.nanmedian()
            aikit.array(3.)
        >>> a.nanmedian(axis=0)
            aikit.array([6.5, 2. , 2.5])
        """
    ...
    def bincount(
        ...
        *,
        ...
        Examples
        --------
        >>> a = aikit.array([0, 1, 1, 3, 2, 1, 7])
        >>> a.bincount()
            aikit.array([1, 3, 1, 1, 0, 0, 0, 1])
        >>> a.bincount(minlength=10)
            aikit.array([1, 3, 1, 1, 0, 0, 0, 1, 0, 0])
        >>> a.bincount(weights=aikit.array([0.3, 0.5, 0.2, 0.7, 1., 0.6, 1.]))
            aikit.array([0.3, 1.3, 1. , 0.7, 0. , 0. , 0. , 1. ])
        """
        return aikit.bincount(
            self._data,
            weights=weights,
            minlength=minlength,
            out=out,
    ...
    def igamma(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.igamma. This method simply
        wraps the function, and so the docstring for aikit.igamma also applies to
        this method with minimal changes.
    ...
    def cov(
        self: aikit.Array,
        x2: Optional[Union[aikit.Array, aikit.NativeArray]] = None,
        /,
        *,
        rowVar: bool = True,
        bias: bool = False,
        ...
        """aikit.Array instance method variant of aikit.cov. This method simply
    ...
    def cummax(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.cummax. This method simply
        wraps the function, and so the docstring for aikit.cummax also applies to
        this method with minimal changes.
        ...
        --------
        >>> x = aikit.array([1, 2, 5, 4, 3])
        >>> y = x.cummax()
        >>> print(y)
        (aikit.array([1, 2, 5, 5, 5]), aikit.array([0, 1, 2, 2, 2]))
    ...
    def cummin(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.cummin. This method simply
        wraps the function, and so the docstring for aikit.cummin also applies to
        this method with minimal changes.
