...
class _ArrayWithManipulationExperimental(abc.ABC):
    ...
    def moveaxis(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.moveaxis. This method
        ...
        (5, 3, 4)
        """
        return aikit.moveaxis(self._data, source, destination, copy=copy, out=out)
    ...
    def heaviside(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.heaviside. This method
        ...
        aikit.array([0., -2., 1.])
        """
        return aikit.heaviside(self._data, x2, out=out)
    ...
    def flipud(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.flipud. This method simply
        wraps the function, and so the docstring for aikit.flipud also applies to
        ...
        aikit.array([[ 0.,  0.,  3.],
            ...
            [ 1.,  0.,  0.]])
        """
        return aikit.flipud(self._data, copy=copy, out=out)
    ...
    def vstack(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.vstack. This method simply
    ...
    def hstack(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.hstack. This method simply
        wraps the function, and so the docstring for aikit.hstack also applies to
        this method with minimal changes.
    ...
    def rot90(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.rot90. This method simply
        ...
        aikit.array([[[3, 2],
               ...
               [[7, 6],
                [5, 4]]])
        """
        return aikit.rot90(self._data, copy=copy, k=k, axes=axes, out=out)
    ...
    def top_k(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.top_k. This method simply
        ...
        """
        return aikit.top_k(self, k, axis=axis, largest=largest, sorted=sorted, out=out)
    ...
    def fliplr(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.fliplr. This method simply
        wraps the function, and so the docstring for aikit.fliplr also applies to
        this method with minimal changes.
        ...
        aikit.array([[0, 0, 1],
               ...
               [3, 0, 0]])
        """
        return aikit.fliplr(self._data, copy=copy, out=out)
    ...
    def i0(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.i0. This method simply
        ...
        """
        return aikit.i0(self._data, out=out)
    ...
    def flatten(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.flatten. This method simply
        wraps the function, and so the docstring for aikit.flatten also applies
    ...
    def pad(
        ...
        **kwargs: Optional[Any],
        ...
        """aikit.Array instance method variant of aikit.pad.
    ...
    def vsplit(
        self: aikit.Array,
        indices_or_sections: Union[int, Sequence[int], aikit.Array],
        /,
        *,
        copy: Optional[bool] = None,
    ) -> List[aikit.Array]:
        """aikit.Array instance method variant of aikit.vsplit. This method simply
        wraps the function, and so the docstring for aikit.vsplit also applies to
        this method with minimal changes.
        ...
        """
        return aikit.vsplit(self._data, indices_or_sections, copy=copy)
    ...
    def dsplit(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.dsplit. This method simply
        wraps the function, and so the docstring for aikit.dsplit also applies to
        this method with minimal changes.
        ...
        """
        return aikit.dsplit(self._data, indices_or_sections, copy=copy)

    @handle_view
    def atleast_1d(
        self: aikit.Array,
        *arys: Union[aikit.Array, bool, Number],
        copy: Optional[bool] = None,
    ) -> List[aikit.Array]:
        """aikit.Array instance method variant of aikit.atleast_1d. This method
        ...
        Examples
        --------
        >>> a1 = aikit.array([[1,2,3]])
        >>> a2 = aikit.array(4)
        >>> a1.atleast_1d(a2,5,6)
        [aikit.array([[1, 2, 3]]), aikit.array([4]), aikit.array([5]), aikit.array([6])]
        """
        return aikit.atleast_1d(self._data, *arys, copy=copy)
    ...
    def dstack(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.dstack. This method simply
    ...
    def atleast_2d(
        ...
        *arys: aikit.Array,
        ...
        """aikit.Array instance method variant of aikit.atleast_2d. This method
        ...
        [aikit.array([[1, 2, 3]]), aikit.array([[4]]), aikit.array([[5]]), aikit.array([[6]])]
        """
        return aikit.atleast_2d(self._data, *arys, copy=copy)
    ...
    def atleast_3d(
        ...
        *arys: Union[aikit.Array, bool, Number],
        ...
        """aikit.Array instance method variant of aikit.atleast_3d. This method
        ...
        [aikit.array([[[1],
                [2],
                [3]]]), aikit.array([[[4],
                [8]]]), aikit.array([[[5]]]), aikit.array([[[6]]])]
        """
        return aikit.atleast_3d(self._data, *arys, copy=copy)
    ...
    def take_along_axis(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.take_along_axis. This
        ...
        """
        return aikit.take_along_axis(self._data, indices, axis, mode=mode, out=out)
    ...
    def hsplit(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.hsplit. This method simply
        wraps the function, and so the docstring for aikit.hsplit also applies to
        this method with minimal changes.
        ...
        [aikit.array([[ 0.,  1.],
         ...
         aikit.array([[ 2.,  3.],
                    ...
                    [14., 15.]]))
        """
        return aikit.hsplit(self._data, indices_or_sections, copy=copy)
    ...
    def expand(
        ...
        *,
        ...
        ret
            Output Array
        """
        return aikit.expand(self._data, shape, copy=copy, out=out)
    ...
    def as_strided(
        ...
        ret
            Output Array
        """
        return aikit.as_strided(self._data, shape, strides)
    ...
    def concat_from_sequence(
        ...
        *,
        ...
        """
        if new_axis == 0:
            return aikit.concat_from_sequence(
    ...
    def associative_scan(
        ...
        *,
        ...
        """
        return aikit.associative_scan(self._data, fn, reverse=reverse, axis=axis)
    ...
    def unique_consecutive(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.unique_consecutive.

        This method simply wraps the function, and so the docstring for
        aikit.unique_consecutive also applies to this method with minimal
        changes.
        """
        return aikit.unique_consecutive(self._data, axis=axis)
    ...
    def fill_diagonal(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.fill_diag.

        This method simply wraps the function, and so the docstring for
        aikit.fill_diag also applies to this method with minimal changes.
        """
        return aikit.fill_diagonal(self._data, v, wrap=wrap)
    ...
    def take(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.take.
    ...
    def trim_zeros(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.trim_zeros.

        This method simply wraps the function, and so the docstring for
        aikit.trim_zeros also applies to this method with minimal changes.
        ...
        [8, 3]
        """
        return aikit.trim_zeros(self, trim=trim)
    ...
    def unfold(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.unfold. This method simply
        wraps the function, and so the docstring for aikit.unfold also applies to
        this method with minimal changes.
        ...
        """
        return aikit.unfold(self._data, mode, out=out)
    ...
    def fold(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.fold. This method simply
        wraps the function, and so the docstring for aikit.fold also applies to
        this method with minimal changes.
        ...
        """
        return aikit.fold(self._data, mode, shape, out=out)
    ...
    def partial_unfold(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.partial_unfold. This method
        simply wraps the function, and so the docstring for aikit.partial_unfold
    ...
    def partial_fold(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.partial_fold. This method
        simply wraps the function, and so the docstring for aikit.partial_fold
        also applies to this method with minimal changes.
        ...
        """
        return aikit.partial_fold(self._data, mode, shape, skip_begin, out=out)
    ...
    def partial_tensor_to_vec(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.partial_tensor_to_vec. This
        method simply wraps the function, and so the docstring for
        ...
        """
        return aikit.partial_tensor_to_vec(self._data, skip_begin, skip_end, out=out)
    ...
    def partial_vec_to_tensor(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.partial_vec_to_tensor. This
        method simply wraps the function, and so the docstring for
        ...
        ret
            full tensor
        """
        return aikit.partial_vec_to_tensor(self._data, shape, skip_begin, out=out)
    ...
    def matricize(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.matricize. This method
        simply wraps the function, and so the docstring for aikit.matricize also
        applies to this method with minimal changes.
        ...
        """
        return aikit.matricize(self._data, row_modes, column_modes, out=out)
    ...
    def soft_thresholding(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.soft_thresholding. This
        method simply wraps the function, and so the docstring for
        aikit.soft_thresholding also applies to this method with minimal changes.
        ...
        """
        return aikit.soft_thresholding(self._data, threshold, out=out)
    ...
    def column_stack(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.column_stack.
        ...
        if isinstance(arrays, tuple):
            ...
            x = [self._data] + arrays
        return aikit.column_stack(x, out=out)
    ...
    def put_along_axis(
        ...
        *,
        ...
        """aikit.Array instance method variant of aikit.put_along_axis.

        This method simply wraps the function, and so the docstring for
        aikit.put_along_axis also applies to this method with minimal
        changes.
        """
        return aikit.put_along_axis(self._data, indices, values, axis, mode=mode, out=out)
