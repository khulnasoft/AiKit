...
class _ArrayWithSet(abc.ABC):
    def unique_counts(self: aikit.Array) -> Tuple[aikit.Array, aikit.Array]:
        """aikit.Array instance method variant of aikit.unique_counts. This method
        simply wraps the function, and so the docstring for aikit.unique_counts
        ...
        Examples
        --------
        >>> x = aikit.array([0., 1., 2. , 1. , 0.])
        >>> y = x.unique_counts()
        >>> print(y)
        Results(values=aikit.array([0.,1.,2.]),counts=aikit.array([2,2,1]))
        """
        return aikit.unique_counts(self._data)
    ...
    def unique_values(
        ...
        Parameters
        ----------
        x : aikit.Array or aikit.NativeArray
            Input array. If `x` has more than one dimension, the function must flatten
            `x` and return the unique elements of the flattened array.
        ...
        aikit.array([1, 2, 3, 4])
        """
        return aikit.unique_values(self._data, out=out)
    ...
    def unique_all(
        ...
        *,
        ...
        by_value: bool = True,
    ) -> Tuple[aikit.Array, aikit.Array, aikit.Array, aikit.Array]:
        """aikit.Array instance method variant of aikit.unique_all. This method
        ...
        ret
            ...
            The details can be found in the docstring for aikit.unique_all.
        ...
        """
        return aikit.unique_all(self._data, axis=axis, by_value=by_value)

    def unique_inverse(self: aikit.Array) -> Tuple[aikit.Array, aikit.Array]:
        """aikit.Array instance method variant of aikit.unique_inverse. This method
        simply wraps the function, and so the docstring for aikit.unique_inverse
        also applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = aikit.array([0.3,0.4,0.7,0.4,0.2,0.8,0.5])
        >>> y = x.unique_inverse()
        >>> print(y)
        Results(values=aikit.array([0.2, 0.3, 0.4, 0.5, 0.7, 0.8]),
                inverse_indices=aikit.array([1, 2, 4, 2, 0, 5, 3]))
        """
        return aikit.unique_inverse(self._data)
