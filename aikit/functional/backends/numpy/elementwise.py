...
def divide(
    ...
    *,
    ...
    if aikit.is_float_dtype(x1.dtype) or aikit.is_complex_dtype(x1.dtype):
        ...
        ret = np.asarray(ret, dtype=aikit.default_float_dtype(as_native=True))
    return ret
...
def logaddexp2(
    ...
    *,
    ...
    if not aikit.is_float_dtype(x1):
        x1 = x1.astype(aikit.default_float_dtype(as_native=True))
        x2 = x2.astype(aikit.default_float_dtype(as_native=True))
