...
@with_unsupported_dtypes({"1.26.2 and below": ("float16", "complex")}, backend_version)
def cholesky(
...
@with_unsupported_dtypes(
    {"1.26.2 and below": ("bfloat16", "float16", "complex")},
    backend_version,
)
def inv(
    x: np.ndarray,
...
@with_unsupported_dtypes(
    {"1.26.2 and below": ("float16", "bfloat16", "complex")},
    backend_version,
)
@_scalar_output_to_0d_array
def matrix_rank(
