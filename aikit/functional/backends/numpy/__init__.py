...
valid_float_dtypes = {"1.26.2 and below": (aikit.float16, aikit.float32, aikit.float64)}
valid_uint_dtypes = {
    "1.26.2 and below": (aikit.uint8, aikit.uint16, aikit.uint32, aikit.uint64)
}
valid_complex_dtypes = {"1.26.2 and below": (aikit.complex64, aikit.complex128)}
...
# invalid data types
# update these to add new dtypes
invalid_dtypes = {"1.26.2 and below": (aikit.bfloat16,)}
invalid_numeric_dtypes = {"1.26.2 and below": (aikit.bfloat16,)}
invalid_int_dtypes = {"1.26.2 and below": ()}
invalid_float_dtypes = {"1.26.2 and below": (aikit.bfloat16,)}
