...
def arange(
    ...
    *,
    ...
    if dtype is None:
        ...
        dtype = aikit.as_native_dtype(aikit.default_dtype(dtype=dtype))
...
def asarray(
    ...
    *,
    ...
    if isinstance(obj, Sequence) and len(obj) != 0:
        contain_tensor = aikit.nested_any(obj, lambda x: isinstance(x, torch.Tensor))
...
@with_unsupported_device_and_dtypes(
    {"2.1.1 and below": {"cpu": ("float16",)}}, backend_version
)
def linspace(
