...
def matmul(
    ...
    *,
    ...
    if (
        ...
        raise aikit.utils.exceptions.AikitException("Error,shapes not compatible")
    ...
    ret = aikit.to_native(aikit.astype(ret, dtype_from, copy=False))
    if x1_padded_2:
        ret = ret[0]
    elif x1_padded:
...
def pinv(
    ...
    *,
    ...
    if rtol is None:
        ...
        x, rtol = aikit.promote_types_of_inputs(x, rtol)
...
def tensordot(
    ...
    *,
    ...
    dtype = aikit.as_native_dtype(aikit.promote_types(x1.dtype, x2.dtype))
