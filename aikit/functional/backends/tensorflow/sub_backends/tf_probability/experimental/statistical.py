...
from aikit.functional.backends.numpy.experimental.statistical import (
    _handle_axis,
    _quantile,
    _validate_quantile,
)
...
def _nanmedian_helper(input, axis=None, keepdims=False):
    ...
    for example: [[12.0 ,4.0 ,aikit.nan], [aikit.nan, aikit.nan,2.2]] => returned:
    ...
    For example: input = [[aikit.nan, 3, aikit.nan, 7],[4, aikit.nan,6, 9]], axis=1
