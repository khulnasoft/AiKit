...
# local
from aikit.func_wrapper import with_unsupported_dtypes, handle_out_argument
from .. import backend_version
import aikit
from aikit.functional.aikit.experimental.manipulation import _to_tf_padding
...
def concat_from_sequence(
    ...
    *,
    ...
    for i in input_sequence:
        highest_dtype = aikit.as_native_dtype(aikit.promote_types(highest_dtype, i.dtype))
