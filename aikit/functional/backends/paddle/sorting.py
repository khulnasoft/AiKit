...
# local
import aikit
from aikit.func_wrapper import with_unsupported_device_and_dtypes, with_supported_dtypes
...
def searchsorted(
    ...
    *,
    ...
    if sorter is not None:
        ...
        if aikit.as_native_dtype(sorter.dtype) not in [paddle.int32, paddle.int64]:
