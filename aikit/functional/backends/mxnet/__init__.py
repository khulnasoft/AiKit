...
valid_int_dtypes = {"1.9.1 and below": (aikit.int8, aikit.int32, aikit.int64, aikit.uint8)}
valid_float_dtypes = {"1.9.1 and below": (aikit.float16, aikit.float32, aikit.float64)}
valid_uint_dtypes = {"1.9.1 and below": (aikit.uint8,)}
...
# update these to add new dtypes
invalid_dtypes = {"1.9.1 and below": (aikit.int16, aikit.uint32, aikit.uint64, aikit.uint16)}
invalid_numeric_dtypes = {
    "1.9.1 and below": (aikit.int16, aikit.uint32, aikit.uint64, aikit.uint16)
}
invalid_int_dtypes = {
    "1.9.1 and below": (aikit.int16, aikit.uint16, aikit.uint32, aikit.uint64)
}
invalid_float_dtypes = {"1.9.1 and below": (aikit.bfloat16,)}
invalid_uint_dtypes = {"1.9.1 and below": (aikit.uint16, aikit.uint32, aikit.uint64)}
invalid_complex_dtypes = {"1.9.1 and below": (aikit.complex64, aikit.complex128)}
