import aikit
from aikit.functional.frontends.sklearn.base import BaseEstimator as XGBModelBase
from aikit.functional.frontends.sklearn.base import ClassifierMixin as XGBClassifierBase
...
class XGBModel(XGBModelBase):
    ...
    def get_params(self, deep=True):
        ...
        if isinstance(params["random_state"], int):
            aikit.seed(seed_value=params["random_state"])
