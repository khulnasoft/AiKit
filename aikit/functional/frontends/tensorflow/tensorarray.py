...
class TensorArray:
    def __init__(
        ...
        self._element_shape = (
            aikit.Shape(element_shape) if element_shape is not None else element_shape
        )
    ...
    def read(self, index, name=None):
        if isinstance(index, EagerTensor):
            index = aikit.to_scalar(index.aikit_array)
