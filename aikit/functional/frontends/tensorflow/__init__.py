...
tensorflow_enum_to_type = {
    1: aikit.FloatDtype("float32"),
    2: aikit.FloatDtype("float64"),
    3: aikit.IntDtype("int32"),
    4: aikit.UintDtype("uint8"),
    5: aikit.IntDtype("int16"),
    6: aikit.IntDtype("int8"),
    8: aikit.ComplexDtype("complex64"),
    9: aikit.IntDtype("int64"),
    10: aikit.Dtype("bool"),
    14: aikit.FloatDtype("bfloat16"),
    17: aikit.UintDtype("uint16"),
    18: aikit.ComplexDtype("complex128"),
    19: aikit.FloatDtype("float16"),
    22: aikit.UintDtype("uint32"),
    23: aikit.UintDtype("uint64"),
}
...
def check_tensorflow_casting(x1, x2):
    ...
    if hasattr(x1, "dtype") and not hasattr(x2, "dtype"):
        x1 = aikit.asarray(x1)
        x2 = aikit.asarray(x2, dtype=x1.dtype)
    else:
        x1 = aikit.asarray(x1)
        if not hasattr(x2, "dtype"):
            x2 = aikit.asarray(x2, dtype=x1.dtype)
        aikit.utils.assertions.check_same_dtype(x1, x2)
    return x1, x2
