...
# local
from aikit.functional.frontends.torch.nn.parameter import Parameter
from aikit.functional.frontends.torch.tensor import Tensor


class Module(aikit.Module):
    _version: int = 1
    training: bool
                    ...
                    (
                        {
                            ...
                            and not isinstance(_v, aikit.Container)
                        }
                    ),
                    **v,
                )
    ...
    def _replace_update_v(self, new_v, native=None):
        ...
        native = aikit.default(native, self)
