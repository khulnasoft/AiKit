...
int8 = aikit.IntDtype("int8")
int16 = aikit.IntDtype("int16")
int32 = aikit.IntDtype("int32")
int64 = aikit.IntDtype("int64")
uint8 = aikit.UintDtype("uint8")
uint16 = aikit.UintDtype("uint16")
uint32 = aikit.UintDtype("uint32")
uint64 = aikit.UintDtype("uint64")
bfloat16 = aikit.FloatDtype("bfloat16")
float16 = aikit.FloatDtype("float16")
float32 = aikit.FloatDtype("float32")
float64 = aikit.FloatDtype("float64")
complex64 = aikit.ComplexDtype("complex64")
complex128 = aikit.ComplexDtype("complex128")
bool = aikit.Dtype("bool")
...
def promote_types_torch(
    ...
    try:
        ret = torch_frontend.torch_promotion_table[
            (aikit.as_aikit_dtype(type1), aikit.as_aikit_dtype(type2))
        ]
    except KeyError:
...
def promote_types_of_torch_inputs(
    ...
    """
    if aikit.isscalar(x1) and aikit.is_int_dtype(x1):
        x1 = aikit.asarray(x1, dtype="int64")
    elif aikit.isscalar(x1):
        x1 = aikit.asarray(x1)
    if aikit.isscalar(x2) and aikit.is_int_dtype(x2):
        x2 = aikit.asarray(x2, dtype="int64")
    elif aikit.isscalar(x2):
        x2 = aikit.asarray(x2)
