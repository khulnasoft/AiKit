...
class Index:
    ...
    def _tokenize_1d(x: Iterable):
        return aikit.array([v for v, _ in enumerate(x)])
    ...
    def isin(self, values, level=None):
        # todo handle level with mutliindexer
        return aikit.isin(self.index_array, values)
