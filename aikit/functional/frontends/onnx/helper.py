from aikit.functional.frontends.onnx.proto import NodeProto

from aikit_tests.test_aikit.helpers.testing_helpers import _import_fn
...
def make_node(
    ...
    fn_tree = "aikit.functional.frontends.onnx." + op_type
