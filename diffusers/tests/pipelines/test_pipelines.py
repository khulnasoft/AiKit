...
class CustomPipelineTests(unittest.TestCase):
    ...
    def test_load_custom_github(self):
        ...
        # make sure that on "main" pipeline gives only ones because of: https://github.com/khulnasoft/aikit/diffusers/pull/1690
        with torch.no_grad():
            output = pipeline()
    ...
    def test_local_custom_pipeline_repo(self):
        ...
        assert images[0].shape == (1, 32, 32, 3)
        # compare to https://github.com/khulnasoft/aikit/diffusers/blob/main/tests/fixtures/custom_pipeline/pipeline.py#L102
    ...
    def test_download_from_git(self):
        ...
        # https://github.com/khulnasoft/aikit/diffusers/blob/main/examples/community/clip_guided_stable_diffusion.py
