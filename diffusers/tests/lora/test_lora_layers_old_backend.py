...
def create_lora_3d_layers(model, mock_weights: bool = True):
    ...
    for name in model.attn_processors.keys():
        ...
        if name.startswith("mid_block"):
            ...
            # Note that the `8 * ...` comes from: https://github.com/khulnasoft/aikit/diffusers/blob/7139f0e874f10b2463caa8cbd585762a309d12d6/src/diffusers/models/unet_3d_condition.py#L148
