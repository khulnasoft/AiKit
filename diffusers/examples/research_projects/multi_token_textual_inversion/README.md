...
**IMPORTART: This research project is deprecated. Multi Token Textual Inversion is now supported natively in [the official textual inversion example](https://github.com/khulnasoft/aikit/diffusers/tree/main/examples/textual_inversion#running-locally-with-pytorch).**
