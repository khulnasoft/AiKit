...
\nFor more details on the training, please follow [this link](https://github.com/khulnasoft/aikit/diffusers/blob/main/examples/custom_diffusion).
"""
...
def main(args):
    ...
    # Code taken from https://github.com/khulnasoft/aikit/diffusers/blob/main/examples/textual_inversion/textual_inversion.py
    modifier_token_id = []
