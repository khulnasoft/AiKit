...
class LLMGroundedDiffusionPipeline(
    ...
    def __init__(
        ...
        if safety_checker is None and requires_safety_checker:
            logger.warning(
                ...
                " information, please have a look at https://github.com/khulnasoft/aikit/diffusers/pull/254 ."
            )
    ...
    def __call__(
        ...
        Args:
            ...
            cross_attention_kwargs (`dict`, *optional*):
                ...
                [`self.processor`](https://github.com/khulnasoft/aikit/diffusers/blob/main/src/diffusers/models/attention_processor.py).
    ...
    # The design choice of not inheriting from StableDiffusionPipeline is discussed here: https://github.com/khulnasoft/aikit/diffusers/pull/5993#issuecomment-1834258517
