...
## Use it with the [🧨 diffusers library](https://github.com/khulnasoft/aikit/diffusers)
...
The weights were trained using [🧨 diffusers Advanced Dreambooth Training Script](https://github.com/khulnasoft/aikit/diffusers/blob/main/examples/advanced_diffusion_training/train_dreambooth_lora_sdxl_advanced.py).
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to pretrained VAE model with better numerical stability. More details: https://github.com/khulnasoft/aikit/diffusers/pull/4038.",
    )
    parser.add_argument(
        "--revision",
        type=str,
