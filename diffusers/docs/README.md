...
the filename without the extension in the [`_toctree.yml`](https://github.com/khulnasoft/aikit/diffusers/blob/main/docs/source/en/_toctree.yml) file.
...
The `khulnasoft/aikit/diffusers` documentation follows the
