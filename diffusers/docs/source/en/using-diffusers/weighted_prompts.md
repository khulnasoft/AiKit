...
If your favorite pipeline doesn't have a `prompt_embeds` parameter, please open an [issue](https://github.com/khulnasoft/aikit/diffusers/issues/new/choose) so we can add it!
