...
🤗 Diffusers provides a [conversion script](https://github.com/khulnasoft/aikit/diffusers/blob/main/scripts/convert_original_stable_diffusion_to_diffusers.py) for converting `.ckpt` files. This approach is more reliable than the Space above.
