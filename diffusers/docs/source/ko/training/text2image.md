...
<frameworkcontent>
<pt>
다음과 같이 [Pokémon BLIP 캡션](https://huggingface.co/datasets/lambdalabs/pokemon-blip-captions) 데이터셋에서 파인튜닝 실행을 위해 [PyTorch 학습 스크립트](https://github.com/khulnasoft/aikit/diffusers/blob/main/examples/text_to_image/train_text_to_image.py)를 실행합니다:
...
그러면 다음과 같이 [Flax 학습 스크립트](https://github.com/khulnasoft/aikit/diffusers/blob/main/examples/text_to_image/train_text_to_image_flax.py)를 실행할 수 있습니다.
