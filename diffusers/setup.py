...
setup(
    ...
    author="The Hugging Face team (past and future) with the help of all our contributors (https://github.com/khulnasoft/aikit/diffusers/graphs/contributors)",
    author_email="patrick@huggingface.co",
    url="https://github.com/khulnasoft/aikit/diffusers",
    package_dir={"": "src"},
