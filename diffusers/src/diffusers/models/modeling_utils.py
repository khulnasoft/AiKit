...
def load_model_dict_into_meta(
    ...
    for param_name, param in state_dict.items():
        ...
        if empty_state_dict[param_name].shape != param.shape:
            ...
            raise ValueError(
                f"Cannot load {model_name_or_path_str}because {param_name} expected shape {empty_state_dict[param_name]}, but got {param.shape}. If you want to instead overwrite randomly initialized weights, please make sure to pass both `low_cpu_mem_usage=False` and `ignore_mismatched_sizes=True`. For more information, see also: https://github.com/khulnasoft/aikit/diffusers/issues/1619#issuecomment-1345604389 as an example."
            )
...
class ModelMixin(torch.nn.Module, PushToHubMixin):
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        config attributes directly. See https://github.com/khulnasoft/aikit/diffusers/pull/3129 We need to overwrite
