...
class ControlNetXSModel(ModelMixin, ConfigMixin):
    ...
    def init_original(cls, base_model: UNet2DConditionModel, is_sdxl=True):
        ...
        def get_dim_attn_heads(base_model: UNet2DConditionModel, size_ratio: float, num_attn_heads: int):
            """
            Currently, diffusers can only set the dimension of attention heads (see https://github.com/khulnasoft/aikit/diffusers/issues/2011#issuecomment-1547958131 for why).
    ...
    def from_unet(
        ...
        Parameters:
            ...
            num_attention_heads (`Union[int, Tuple[int]]`, *optional*):
                The dimension of the attention heads. The naming seems a bit confusing and it is, see https://github.com/khulnasoft/aikit/diffusers/issues/2011#issuecomment-1547958131 for why.
