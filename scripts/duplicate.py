...
def check_duplicate():
    fn_test_core = get_all_functions_from_directory(
        "aikit_tests/test_aikit/test_functional/test_core"
    )
    fn_test_nn = get_all_functions_from_directory(
        "aikit_tests/test_aikit/test_functional/test_nn"
    )
    fn_test_experimental = get_all_functions_from_directory(
        "aikit_tests/test_aikit/test_functional/test_experimental"
    )
    fn_aikit_test = set(fn_test_core).union(set(fn_test_nn))
    common_list = fn_aikit_test.intersection(set(fn_test_experimental))
    return common_list
